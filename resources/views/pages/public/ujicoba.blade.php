...
<div class="edit-project">
    <div class="container">
        {{-- <form action="{{ route('projectUpdateForm', $responseData['data']['id']) }}" method="post" id="form-dana1"
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control" id="SisaWaktu" hari" disabled>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control" name="currentFundingAmount"
                                                hidden>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control" id="TotalSuku" name="sukuk"
                                                required>
                                            <input type="number" class="form-control" name="soldSukuk" hidden>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
